...
// Clickable Element Wait
	...
	public void actionsdragandDrop1(WebElement source,WebElement target)
	{
		try
		{
			Actions action = new Actions(driver);
	...
	//Windowhandling --> 
		...
		public void captureScreenshot(String screenshotName)
		{
			try
			{
				...
				File dest= new File(System.getProperty("user.dir")+"/Error_Screenshots/"+screenshotName+".png");
